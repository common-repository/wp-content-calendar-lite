...
class Wp_Content_Calendar_Lite_Admin {
	...
	public function wp_content_calendar_lite_create_main_menu() {
		...
		add_submenu_page( $menu_slug, 'Upgrade', 'Get High Quality Articles', 'manage_options', 'wp-content-calendar-lite-upgrade', array($this, 'show_wp_content_calendar_lite_page_upgrade'), 'dashicons dashicons-external' );
	}
	...
	public function show_wp_content_calendar_lite_page_upgrade() {
		echo '<script type="text/javascript">
           		window.location = "http://www.scripted.com/#_a_34"
      		  </script>';
	}
